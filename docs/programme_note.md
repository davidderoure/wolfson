...
## README — David De Roure, bass, with Wolfson

*README* is a live conversation between a human bassist and an artificial musician
that listens, responds, and remembers. Wolfson is a computer system trained on
hundreds of jazz saxophone solos; it hears each bass phrase, analyses its character
— the notes, the rhythm, the energy — and improvises a reply in real time. Over
...
improvisation is, in some sense, an act of memory.

---

*Wolfson College, Oxford — 1 May 2026*
