...
\begin{itemize}
  ...
  \item \musicue{Musical material: 3–5 note fragment — \textit{So What} opening figure (D–F–G–A); or the \textit{A Love Supreme} bass motif (A–B$\flat$–C–E), recognised well beyond jazz circles. Echo lands on sax immediately. Keep it melodic; chromatic lines are harder to follow.}
\end{itemize}
&
...
\begin{itemize}
  ...
  \item \musicue{Modal groove \textbf{continuously for 8–10\,s} → sax enters trading mode and solos over your groove. Options — \textit{So What} vamp (D Dorian); \textit{Cantaloupe Island} F minor vamp (stay on the F minor section, skip the D$\flat$/D$\natural$ changes — highest audience recognition via US3 sample); \textit{Footprints} in 4/4 (C minor Dorian). Pitch-class tracking shifts the sax to whichever tonality you establish.}
